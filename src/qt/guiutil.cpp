...
{
    // Convert bistot:// to bistot:
    //
    //    Cannot handle this later, because bitcoin:// will cause Qt to see the part after // as host,
    //    which will lower-case it (and thus invalidate the address).
    if(uri.startsWith("bistot://"))
    {
        uri.replace(0, 12, "bistot:");
    }
...
{
    return GetSpecialFolderPath(CSIDL_STARTUP) / "bistot.lnk";
}
...
{
    return GetAutostartDir() / "bistot.desktop";
}
...
HelpMessageBox::HelpMessageBox(QWidget *parent) :
    QMessageBox(parent)
{
    header = tr("bistot-Qt") + " " + tr("version") + " " +
        QString::fromStdString(FormatFullVersion()) + "\n\n" +
        tr("Usage:") + "\n" +
        "  bistot-qt [" + tr("command-line options") + "]                     " + "\n";
...
void SetDarkThemeQSS(QApplication& app)
{
    app.setStyleSheet("QWidget        { background: rgb(41,44,48); }"
                      ...
                      "QPushButton    { background: rgb(102,217,239); color: rgb(21,21,21); }"
                      ...
                      "QToolButton:checked { color: rgb(255,255,255); border: none; border-left-color: rgb(102,217,239); border-left-style: solid; border-left-width: 6px; }"
