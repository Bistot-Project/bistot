...
#if defined(NDEBUG)
# error "Bistot cannot be compiled without assertions."
#endif
...
const string strMessageMagic = "Bistot Signed Message:\n";
...
int64_t GetProofOfWorkReward(int64_t nFees, int nHeight)
{
  int64_t nSubsidy = 88 * COIN;
    ...
    if (!TestNet())
    nSubsidy >>= (pindexBest->nHeight / 105120);
    else
    nSubsidy >>= (pindexBest->nHeight / 500);
