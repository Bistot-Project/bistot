# Cross-Compiling bistot QT for Windows 
...
```
To make a Windows executable, clone the bistot repository to /mnt/  folder 
 ```
    $ cd /mnt
    $ git clone https://github.com/bistotpirate/bistot.git
```
Make bash script for compilation:
```
    $ cd /mnt/bistot
    $ touch compile-bistot.sh
    $ chmod ugo+x compile-bistot.sh
```
Content of compile-bistot.sh:
   ```  $ nano compile-bistot.sh```
   ```
//////////////////////////////////////////////////////////////////////////////////////////////
#!/bin/bash
...
i686-w64-mingw32.static-qmake-qt5 \
	...
	QMAKE_LRELEASE=/mnt/mxe/usr/i686-w64-mingw32.static/qt5/bin/lrelease bistot-qt.pro
...
output :``` $ ./compile-bistot.sh ``` will create a file called `release/bistot-qt.exe`
